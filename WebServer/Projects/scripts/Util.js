(function(global, factory) {
  ...
  var Define = function(name, value, opts = {}) {
    opts = {enumerable: true, configurable: true, ...opts};
    if(typeof value === 'function') {
      var decor = function() {return value.call(this, ...arguments)};
      if(typeof name === 'string') {
        ...
        if(this instanceof Util) fns[name] = decor;
      }
      Object.defineProperty(this, name, {value: decor, writable: true, ...opts});
      return decor;
    }
    Object.defineProperty(this, name, {value, writable: true, ...opts})
    return value;
  };
  ...
  define("print", function(...text) {
    ...
    isColored = typeof isColored === "undefined" ? fns.defaults.colored : isColored;
  ...
  define("def", function(name, fnOrArgs) {
    ...
    else if(mode === "excute") return defFns.get(name)(...(!fns.isType(fnOrArgs, Array) ? [fnOrArgs] : fnOrArgs));
  });
